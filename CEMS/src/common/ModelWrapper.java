...
public class ModelWrapper<E> implements Serializable {
	...
	public enum Operation {
		CREATE_EXAM, UPDATE_TEST, ENTERED_WRONG_ID, ERROR, LOAD_TEST, LOAD_QUESTION, LOAD_TEST_LIST, LOAD_QUESTION_LIST,
		...
		GET_EXAMS_LIST_BY_COURSE,GET_EXAMS_LIST,CLOSE_EXAM
	};
