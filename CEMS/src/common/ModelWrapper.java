...
public class ModelWrapper<E> implements Serializable {
	...
	public enum Operation {
		...
		GET_EXECUTED_EXAM_LIST_BY_COURSE, GET_EXECUTED_EXAM_LIST_BY_STUDENT, STATISTIC_BY_TEACHER, STATISTIC_BY_STUDENT,
		...
		CHECK_CODE_BEFORE_INSERTION, GET_EXTENSION_REQUESTS,EXTENSION_CONFIRM
	};
